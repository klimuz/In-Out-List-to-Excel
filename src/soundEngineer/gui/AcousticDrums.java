...
//background image start
        try {
            Image backgroundImage = ImageIO.read(new File("img/acousticDrums.jpg"));
...
//Elements start
        ...
        if (ProjectData.drumStrips.contains("Sn1B")) {
        ...
        } else if (ProjectData.drumStrips.contains("Sn2")) {
        ...
        } else if (ProjectData.drumStrips.contains("OH1")) overNumber.setSelectedItem("2");
...
//Button apply start
        ...
        buttonApply.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                drumChannels.setText("Drum Channels: " + ProjectData.drumStrips.size());
            }
        });
//Button apply end
