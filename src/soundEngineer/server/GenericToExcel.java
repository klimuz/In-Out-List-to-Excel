...
public class GenericToExcel {
    ...
    private void createHeader(int rowNum) {
     ...
     public void inputListGenericToExel(ArrayList<ChannelStrip> inputList) throws IOException {
...
//instrument
    ...
    File file1 = new File(ProjectData.filePath + "/" + ProjectData.projectName + " In-out list.xls");
